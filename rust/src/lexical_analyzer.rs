...
impl TokenParser {
    ...
    fn transition(current_state: &State, next_char: &char) -> Option<State> {
        ...
        match (current_state, char_type) {
            ...
            (State::Initial, CharType::Other('.')) => Some(State::DecimalStart),
            ...
            (State::Integer, CharType::Other('.')) => Some(State::DecimalStart),
            //
            (State::DecimalStart, CharType::Digit) => Some(State::Float),
            //
